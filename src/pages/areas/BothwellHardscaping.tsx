...
const BothwellHardscaping: React.FC = () => {
  ...
  const bothwellProjects: Project[] = [
    ...
    },
    {
      ...
      alt: "Premium block paving driveway"
    },
    {
      title: "Block Paving Project 2",
      after: "/Hardscaping-HSC-Block-Paving (1).webp",
      alt: "Quality driveway construction"
    },
    {
      title: "Block Paving Project 3",
      after: "/Block-paving-HSC-Hardscaping (1).webp",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-text-secondary max-w-3xl mx-auto">
              Premium hardscaping installation and exceptional service that Bothwell residents have trusted for over 16 years.
            </p>
          </div>
